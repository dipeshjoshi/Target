...
create table ${hivevar:ARIMAX_DB}.${hivevar:SCORE_INPUT_TABLE} as select mdse_item_i, mdse_clas_i, mdse_dept_ref_i, week_start_date, t1.week_end_date as week_end_date, 0, retl_a, 0, 0 as avg_sales, n_stores, circular_flag, circular_flag_count, 0, 0, dollar_off_flag, dollar_off_flag_count, tpc_flag, tpc_flag_count, pct_off_flag, pct_off_flag_count,
